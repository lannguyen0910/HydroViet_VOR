...
class mean_average_precision():
    ...
    def update(self, outputs, targets):
        ...
        self.det['categories'].extend(outputs['det_labels'])
        self.det['scores'].extend(outputs['det_scores'])
        self.gt['boxes'].extend(targets['gt_boxes'])
        self.gt['categories'].extend(targets['gt_labels'])
    ...
    def value(self):
        ...
        det_labels = self.det['categories']
        det_scores = self.det['scores']
        true_boxes = self.gt['boxes']
        true_labels = self.gt['categories']
